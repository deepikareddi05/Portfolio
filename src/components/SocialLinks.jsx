...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/deepika-reddi/",
    color: "#0A66C2",
  ...
  
  {
    name: "Gmail",
    displayName: "Gmail",
    subText: "deepikareddi2005@gmail.com",
    icon: MailCheckIcon,
    //url: "deepikareddi2005@gmail.com",
    color: "white",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "deepikareddi05",
    icon: Github,
    url: "github.com/deepikareddi05",
    color: "#ffffff",
