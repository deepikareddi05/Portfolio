...
const WORDS = ["Computer Science Engineer", "Tech Enthusiast"];
const TECH_STACK = ["Java", "C", "Python"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/deepikareddi05" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/deepika-reddi/" },
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Crafting user-friendly and functional web solutions with innovative
